	...
	Pizzicato.Effects.Delay.prototype = Object.create(baseEffect, {
		...
		time: {
			...
			set: function(time) {
				...
				this.delayNode.delayTime.linearRampToValueAtTime(time, Pz.context.currentTime + 0.1);
			}
		},
		...
		feedback: {
			...
			set: function(feedback) {
				...
				this.feedbackGainNode.gain.linearRampToValueAtTime(feedback, Pz.context.currentTime + 0.1);
			}
		}
